...
public interface IChatDAO {
	...
	public Chat find(Chat chat) throws Exception;//所有的聊天记录
	public Chat findByDay(Chat chat) throws Exception;//按天查询聊天记录
	public Chat findByWord(Chat chat) throws Exception;//按关键字查询聊天记录
}
